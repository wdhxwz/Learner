...
import com.wangdh.learner.thrift.Hello.AsyncClient;
import com.wangdh.learner.thrift.Hello.AsyncClient.sayHello_call;
...
public class ThriftAsynClientDemo {
    ...
    public static void main(String[] args) {
        ThriftAsynClientDemo client = new ThriftAsynClientDemo();
